...
import com.github.winefoxbot.mapper.WaterGroupScheduleMapper;
...
public class WaterGroupScheduleServiceImpl extends ServiceImpl<WaterGroupScheduleMapper, WaterGroupSchedule>
    ...
    public void editDailyPush(Long groupId, LocalTime time) {
        ...
        WaterGroupSchedule scheduleToUpdate = new WaterGroupSchedule();
        ...
        boolean success = this.update(scheduleToUpdate, updateWrapper);
    ...
    public void unscheduleDailyPush(Long groupId) {
        jobScheduler.deleteRecurringJob("water-group-push-" + groupId);
