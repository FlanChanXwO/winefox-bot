...
@ConfigurationProperties(prefix = "winefoxbot.plugins.pixiv")
@Data
public class PixivProperties {
    ...
    @Data
    @ConfigurationProperties(prefix = "winefoxbot.plugins.pixiv.bookmark")
    ...
    @Data
    @ConfigurationProperties(prefix = "winefoxbot.plugins.pixiv.bookmark.tracker")
    ...
    @Data
    @ConfigurationProperties(prefix = "winefoxbot.plugins.pixiv.authorization")
    public static class AuthorizationProperties {
        private String xcsrfToken;
    }

    @Data
    @ConfigurationProperties(prefix = "winefoxbot.plugins.pixiv.cookie")
    ...
    @Data
    @ConfigurationProperties(prefix = "winefoxbot.plugins.pixiv.api")
